...
public class ToolingApi {
	...
	public static final String TOOLING_API = "/services/data/v27.0/tooling/";
	public static final String QUERY_API = "/services/data/v27.0/query/";
	public static final String SEARCH_API = "/services/data/v27.0/search/";
	...
	public static JSONObject get(String path, String api) throws IOException {
		...
		HttpGet get = new HttpGet(apiEndpoint + api + path);
	...
	public static JSONObject post(String path, JSONObject jsonIn)
			throws IOException {
		logger.info("Post: path" + path + " JsonIn" +jsonIn);
	...
	public static JSONObject post(String path, String jsonIn)
		...
		HttpClient httpclient = new DefaultHttpClient();
		logger.info("HTTPost: " + apiEndpoint + TOOLING_API + path);
	...
	public static <P> ServiceLoader<P> loadProvider(Class<P> providerClass) {
	...
	public static <S> S getFirstOrThrow(ServiceLoader<S> loader) {
