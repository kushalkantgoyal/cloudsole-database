...
<head>
	...
	<style type="text/css">
		body {
			padding: 0;
			background: #292929 url("/resources/assets/images/left-menu-bg.png");
		}
...
<body>
	...
	<section class="signin-container">
		<a href="dashboard.html" title="CloudSole Developer" class="header">
			<img src="/resources/assets/images/af-logo-signin.png" alt="Sign in to Admin Flare">
			<span>
				Sign in to<br>
